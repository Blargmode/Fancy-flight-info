...
namespace IngameScript
{
	...
	class DataOxygen : IData
	{
		...
		public DataOxygen(List<IMyTerminalBlock> blocks)
		{
			foreach (var block in blocks)
			{
				if (block is IMyGasTank)
				{
					if (block.BlockDefinition.SubtypeId == "" || block.BlockDefinition.SubtypeId.Contains("Oxygen"))
					{
