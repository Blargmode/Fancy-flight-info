...
namespace IngameScript
{
	...
	class FixedWidthText
	{
		...
		//Detailed info can fit 18, but half of the last one is obscured by the scroll-bar, 40 is usually fine.

		private List<string> Text;
		public int Width { get; private set; }

		//Constructor using custom width
		public FixedWidthText(int width = 40)
		{
		...
		public void AppendMultilineString(string t)
		{
			Text.AddArray(t.Split('\n'));
		}
